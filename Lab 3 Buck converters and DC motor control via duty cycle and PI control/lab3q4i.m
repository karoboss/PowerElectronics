...
xprev = x; % update previous state for next iteration
    ...
    figure(1);
    plot(t, Il);
    title(['Current coil for TL=',num2str(TL)]);
    ylabel('I');
    xlabel('time');

    figure(2);
    plot(t, If);
    title(['Current load for TL=',num2str(TL)]);
    ylabel('I');
    xlabel('time');
    ...
    figure(3);
    plot(t, Icoil);
    title(['Capacitor load for TL=',num2str(TL)]);
     ylabel('I');
    xlabel('time');
    ...
    figure(4);
    plot(t, Vc);
    title(['Vc for TL=',num2str(TL)]);
    ylabel('V(V)');
    xlabel('time');

    figure(5);
    plot(t, W);
    title(['Omega for TL=',num2str(TL)]);
    ylabel('Omega(rad/s)');
    xlabel('time');

    figure(6);
    plot(t, Te);
    title(['Torque for TL=',num2str(TL)]);
    ylabel('Torque(Nm)');
    xlabel('time');
