...
timeVecA = (a/360)*cycle_period; % seconds
          ...
          %cycle_period=1/f 2*pi/2*pi*f
            if mod(t(i),(cycle_period))>= timeVecA && mod(t(i),(cycle_period))<timeVecA +(cycle_period)/6
            v_output(i) = Vab(i);
            current_thyr1(i)=1;
            current_thyr2(i)=0;
            current_thyr3(i)=0;
            ...
            current_thyr5(i)=0;
            current_thyr6(i)=0;
            elseif mod(t(i),(cycle_period))>=timeVecA +(1/f)/3 && mod(t(i),(cycle_period))< timeVecA +(cycle_period)/2
            v_output(i) = Vbc(i);
            current_thyr1(i)=0;
            current_thyr2(i)=1;
            current_thyr3(i)=1;
            ...
            current_thyr5(i)=0;
            current_thyr6(i)=0;
            elseif mod(t(i),(cycle_period))>=timeVecA + (2*(cycle_period))/3  && mod(t(i),(cycle_period))< timeVecA +(5*(cycle_period))/6
            v_output(i) = Vca(i);
            current_thyr1(i)=0;
            current_thyr2(i)=0;
            current_thyr3(i)=0;
            ...
            current_thyr5(i)=1;
            current_thyr6(i)=0;
            elseif mod(t(i),(cycle_period))>=timeVecA +(5*(cycle_period))/6  || mod(t(i),(cycle_period))< timeVecA
            v_output(i) = Vcb(i);
            current_thyr1(i)=0;
            current_thyr2(i)=0;
            current_thyr3(i)=0;
